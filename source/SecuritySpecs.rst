...
FuzionView Security Overview
  ...
  * Responsibility for the “container” should be on the facility operator or other data provider.  Responsibility for the exchange of data should be a function of FusionView.
