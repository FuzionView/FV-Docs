...
Go back to the original GSOC ticket by clicking **View Ticket**. For help using GSOC, check out their `documentation <https://gopherstateonecall.org/ticketing/#find-a-ticket>`_ .
...
The **Help** link from the information pane opens the FuzionView documentation.

.. figure:: /_static/T-Documentation.png
